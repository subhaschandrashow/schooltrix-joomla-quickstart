...
namespace Joomla\Component\SchoolTrix\Administrator\Table;
 ...
 * @since  1.5
 */
class StudentTable extends Table implements VersionableTableInterface
{
    /**
    ...
    {
        $this->typeAlias = 'com_schooltrix.student';

        parent::__construct('#__schooltrix_students', 'id', $db);
    ...
    public function stick($pks = null, $state = 1, $userId = 0)
    {
        ...
        /** @var SeasonTable $table */
        $table = Table::getInstance('SeasonTable', __NAMESPACE__ . '\\', ['dbo' => $this->_db]);
