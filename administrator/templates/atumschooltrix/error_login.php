...
$logoBrandLarge  = $this->params->get('logoBrandLarge')
    ...
    : Uri::root(false) . 'media/templates/administrator/atumschooltrix/images/logos/brand-large.svg';
$logoBrandSmall = $this->params->get('logoBrandSmall')
    ? Uri::root(false) . htmlspecialchars($this->params->get('logoBrandSmall'), ENT_QUOTES)
    : Uri::root(false) . 'media/templates/administrator/atumschooltrix/images/logos/brand-small.svg';
...
$loginLogo = $this->params->get('loginLogo')
    ...
    : Uri::root(false) . 'media/templates/administrator/atumschooltrix/images/logos/login.svg';
...
// Enable assets
$wa->usePreset('template.atumschooltrix.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr'))
...
$wa->registerStyle('template.active', '', [], [], ['template.atumschooltrix.' . ($this->direction === 'rtl' ? 'rtl' : 'ltr')]);
...
// @see administrator/templates/atumschooltrix/html/layouts/status.php
